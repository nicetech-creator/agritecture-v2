...
class Gh_Processing_Capex:

    @staticmethod
    def info():
        return {
            "name": "gh_processing_capex",
            "description": "Processing system selector for GH Capex"
        }
    ...
    def compute(args, quantize_output=False):
        ...
        result = dict()
        inputs = parse_inputs(Gh_Processing_Capex.input_type(), args)

        output_type = Gh_Processing_Capex.output_type()
