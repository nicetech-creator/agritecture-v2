...
class Gh_Input_Land_Status:

    @staticmethod
    def info():
        return {
            "name": "gh_input_land_status",
            "description": "Input translator for GH land status"
        }
    ...
    def compute(args, quantize_output=False):
        ...
        result = dict()
        inputs = parse_inputs(Gh_Input_Land_Status.input_type(), args)

        output_type = Gh_Input_Land_Status.output_type()
