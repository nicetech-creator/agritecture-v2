...
class Soil_Defaults:
    ...
    def info():
        return {
            "name": "soil_defaults",
            "description": "Default input values for Soil"
        }
    ...
    def compute(args, quantize_output=False):
        result = dict()
        inputs = parse_inputs(Soil_Defaults.input_type(), args)

        output_type = Soil_Defaults.output_type()
        ...
        result["location_rates"] = Location_Rates.compute(args_location_rates)
