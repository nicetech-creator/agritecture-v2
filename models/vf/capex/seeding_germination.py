...
class Vf_Seeding_Germination_Capex:

    @staticmethod
    def info():
        return {
            "name": "vf_seeding_germination_capex",
            "description": "Seeding and germination system sizing for VF Capex"
        }
    ...
    def compute(args, quantize_output=False):
        ...
        result = dict()
        inputs = parse_inputs(Vf_Seeding_Germination_Capex.input_type(), args)

        output_type = Vf_Seeding_Germination_Capex.output_type()
